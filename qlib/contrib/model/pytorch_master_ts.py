...
class MASTERModel(Model):
    def __init__(self, d_feat: int = 158, d_model: int = 256, t_nhead: int = 4, s_nhead: int = 2, gate_input_start_index=158, gate_input_end_index=221,
            T_dropout_rate=0.5, S_dropout_rate=0.5, beta=None, n_epochs = 40, lr = 8e-6, GPU=0, seed=0, train_stop_loss_thred=None, save_path = '/data/userdata/v-yuanteli/RD-Agent/git_ignore_folder/RD-Agent_workspace/90454c509f6547a7a6000f69e94ff63c/factor/master', save_prefix= '', benchmark = 'SH000300', market = 'csi300', only_backtest = False):
    ...
    def train_epoch(self, data_loader):
        ...
        for data in data_loader:
            ...
            if self.device != torch.device("cpu"):
                ...
                print(f"Current GPU memory usage: {current_memory:.2f} MB, Peak: {peak_memory:.2f} MB")
